...
var (
	...
	ErrMissingBlockCronJobGasLimit   = errors.New("missing genesis system config block cron job gas limit")
...
func (cfg *Config) Check() error {
	...
	if cfg.Genesis.SystemConfig.BlockCronJobGasLimit == 0 {
		return ErrMissingBlockCronJobGasLimit
	}
